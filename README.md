...
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|Language| C#                                                                                                                                                                                                           |
|Framework| .NET 8, .NET 10, netstandard2.0                                                                                                                                                                              |
|Continuous Integration Prod | [![.NET Release](https://github.com/saigkill/SaigkillsToolbox/actions/workflows/dotnet-release.yml/badge.svg)](https://github.com/saigkill/SaigkillsToolbox/actions/workflows/dotnet-release.yml) |
|Continuous Integration Stage | [![.NET Develop](https://github.com/saigkill/SaigkillsToolbox/actions/workflows/dotnet-develop.yml/badge.svg)](https://github.com/saigkill/SaigkillsToolbox/actions/workflows/dotnet-develop.yml)                                                                                                                                                                                                             |
...
A documentation is [there](https://writebook.saschamanns.de/4/saigkills-toolbox).
